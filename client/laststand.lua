...
local isLaststandNuiActive = false

function ShowLaststandNUI()
    if not isLaststandNuiActive then
        isLaststandNuiActive = true
...
function HideLaststandNUI()
    if isLaststandNuiActive then
        isLaststandNuiActive = false
...
RegisterNUICallback("closeLaststand", function(_, cb)
    HideLaststandNUI()
    cb("ok")
end)
